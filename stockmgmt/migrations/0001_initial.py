    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_by', models.CharField(blank=True, choices=[('Cogon', 'Cogon'), ('Kanangga', 'kanangga'), ('Albuera', 'Albuera'), ('Maasin', 'Maasin')], max_length=50, null=True)),
                ('issue_to', models.CharField(blank=True, choices=[('Cogon', 'Cogon'), ('Kanangga', 'kanangga'), ('Albuera', 'Albuera'), ('Maasin', 'Maasin')], max_length=50, null=True)),
